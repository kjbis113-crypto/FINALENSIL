...
const CREATURES = {
  1: {
    ...
    characterLead: '몸 전체에 커다란 발광 기관을 가진 십자 모양 개체.',
    characterBody:
      '클릭으로 방향을 입력받던 회로의 성질이 방향성 있는 발광 반응으로 남음. 몸을 누르면 특정 방향으로 빛을 발산하며, 자극과 발광 사이에 짧은 지연이 관찰됨. 빛의 방향이 이 개체의 유일한 의사 표현 수단으로 추정되나, 수신 측의 해석 여부는 확인되지 않음.',
    media: {
      x: 924,
      y: 44,
      width: 972.244,
    ...
    facts: {
      origin: { heading: [300, 381, 172.5], rule: [297, 428, 595], body: [297, 434.19, 172.5] },
      story: { heading: [297, 534.19, 371], rule: [297, 581, 595], body: [300, 593, 543] },
      character: { heading: [300, 746.19, 624], rule: [294, 793, 600], body: [300, 805, 592] },
    },
  },
  2: {
    origin: '전선류 케이블 뭉치',
    ...
    characterLead: '전선이 노출된 원형 몸통과 다절형 꼬리를 가진 개체.',
    characterBody:
      '전류를 흘려보내던 도체의 성질이 남아, 외부 자극에 극도로 예민한 습성으로 이어짐. 접근을 감지하면 꼬리를 안쪽으로 말아 접촉 면적을 줄이며, 수축은 빠르고 이완은 느림. 개별 전선이었던 시절의 경계는 이미 흐려져, 몇 개체가 결합한 것인지 판정되지 않음.',
    media: {
      x: 924,
      y: 123,
      width: 922.485,
    ...
    facts: {
      origin: { heading: [294, 381.19, 172.5], rule: [294, 428, 600], body: [297, 434.19, 172.5] },
      story: { heading: [297, 534.19, 371], rule: [297, 584, 600], body: [300, 593, 554] },
      character: { heading: [300, 746.19, 624], rule: [300, 793, 600], body: [300, 805, 612] },
    },
  },
  3: {
    origin: '스피커, GPU',
    ...
    characterLead: '둥근 몸통 위로 스피커 진동판 구조가 붙어 있는 개체.',
    characterBody:
      '신호를 처리하고 소리로 출력하던 회로의 성질이 남아, 듣고 모방하여 발성하는 능력으로 이어짐. 자극을 받은 뒤 응답까지 1~2초 정지하며, 같은 자극에도 매번 다르게 반응함. 발효 당시의 접촉 상태가 개체마다 달랐던 탓으로 추정되며, 편찬팀은 이를 종 단위로 기술할 수 없는 유일한 종으로 기록함.',
    media: {
      x: 960,
      y: 146,
      width: 851,
    ...
    facts: {
      origin: { heading: [297, 381, 172.5], rule: [304, 428, 600], body: [297, 436, 172.5] },
      story: { heading: [297, 534.19, 371], rule: [300, 584, 600], body: [300, 593.19, 537] },
      character: { heading: [300, 746.19, 624], rule: [297, 793, 600], body: [300, 805, 597] },
    },
  },
  4: {
    origin: '전구류',
    ...
    characterLead: '속이 비쳐 보이는 갓 모양 몸통 안에 전구 구조가 그대로 남아 있는 개체.',
    characterBody:
      '단독 개체로는 거의 발견되지 않고, 항상 여러 마리의 군집으로 서식함. 낙오된 단독 개체는 소등된 상태로만 발견됨. 다른 무리와 접촉하면 양쪽의 밝기가 함께 떨어져, 강한 텃세와 영역 의식을 가진 것으로 추정됨.',
    media: {
      x: 924,
      y: -149,
      width: 1035.087,
    ...
    facts: {
      origin: { heading: [294, 381.19, 172.5], rule: [294, 428.09, 600], body: [297, 434.19, 172.5] },
      story: { heading: [297, 534.19, 371], rule: [299, 584.09, 589], body: [300, 593.19, 588] },
      character: { heading: [300, 746.19, 624], rule: [303, 793.09, 585], body: [300, 805, 588] },
    },
  },
};
...
/*
 * The layout itself lives in info.css now — one grid for every entry. The only
 * thing a specimen still varies is how far its cutout is zoomed inside the
 * shared media frame. Keeping imageWidth / width preserves each crop exactly as
 * it was framed, so nothing new gets cut off.
 */
page.style.setProperty(
  '--specimen-scale',
  `${(creature.media.imageWidth / creature.media.width) * 100}%`,
);
...
requestAnimationFrame(() => {
  ...
  const encryptedElements = [
    backLink,
    ...document.querySelectorAll('.fact h2, .fact [data-encrypted]'),
  ];
